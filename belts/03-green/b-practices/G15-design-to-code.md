...
- 🟢 GREEN: I can take a Figma frame, walk the five steps, name gaps, and produce running code that uses Blade primitives end-to-end without fighting the design system.
- 🟡 YELLOW — I can do most of the flow but tend to skip gap-naming and end up with ad-hoc components.
- 🔴 RED — I have not done a design-to-code session through the connector + Blade + Code Connect path.

---

## What you can say after this module

> "I take Figma frames through the Figma connector, the Blade design system, and Code Connect into running code that uses real Blade primitives — and I name gaps explicitly instead of papering over them."
