...
- **White Belt Quest W-0: "Turn GREEN":** you run the direct [W.5 readiness checks](../belts/01-white/W05-installing-the-stack.md#what-setup-verification-should-prove), show an all-green checklist, and only then attempt the W-1 quest. Same contract as the second Builder Day's validation checklist. Same reason.
