...
Generated by `scripts/build-project-knowledge.mjs` from playbook **0.22-alpha** (updated 2026-05-12).
...
- `project-instructions.md` — 9.1 KB
- `playbook-spine.md` — 87.6 KB
- `playbook-index.md` — 59.1 KB
- `playbook-glossary.md` — 23.6 KB
- `playbook-cards.md` — 29.2 KB
